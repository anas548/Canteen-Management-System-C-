...
Canteen::Canteen()
{
    ...
    conn = mysql_real_connect(conn, "localhost", "root", "", "canteendb", 0, NULL, 0);//used test database to test
    if (conn)
    {
...
void Canteen::welcome()
{
    ...
    cout<<endl;
    cout<<"----             CARLOS HILADO MEMORIAL STATE UNIVERSITY             ----"<<endl;
    cout<<"========================================================================="<<endl;
    cin.get();
}
